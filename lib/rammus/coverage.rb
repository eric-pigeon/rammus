...
module Rammus
  ...
  class Coverage
    ...
    # @param reset_on_navigation [Boolean] Whether to reset coverage on every navigation. Defaults to true.
    # @param report_anonymous_scripts [Boolean] Whether anonymous scripts generated by the page should be reported. Defaults to false.
    #
    # @return [nil]
    #
